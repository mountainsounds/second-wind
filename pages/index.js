      ...
      <div className="hero-body">
        <div className="container has-text-centered">
          <div id='welcomeInfo' className="column is-6 is-offset-3">
            ...
            <h2 className="subtitle"> I will ship most items assuming the buyer covers costs. I live in between Central and Harvard Square, and can also deliver to Brooklyn Boulders in Somerville, and occasionally Salt Pump Climbing Co. in Maine.</h2>
