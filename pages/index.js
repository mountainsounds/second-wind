      ...
      <div className="hero-body">
        <div className="container has-text-centered">
          <div id='welcomeInfo' className="column is-6 is-offset-3">
            ...
            <h2 className="subtitle"> At the moment, I am not shipping items. I live in between Central and Harvard Square, and can also deliver to Brooklyn Boulders in Sommerville, and occasionally Salt Pump Climbing Co. in Maine.</h2>
